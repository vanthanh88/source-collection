...
protocol CTPageViewDelegate: class {
     ...
     */
    func pageViewController(_ pageViewController: CTPageView,
...
class CTPageView: UIPageViewController {
    
    weak var pageViewDelegate: CTPageViewDelegate?
...
extension CTPageView: UIPageViewControllerDataSource {
...
extension CTPageView: UIPageViewControllerDelegate {
